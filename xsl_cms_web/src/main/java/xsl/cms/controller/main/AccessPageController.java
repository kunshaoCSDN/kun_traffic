package xsl.cms.controller.main;
/**
 * 页面访问控制
 */
...
public class AccessPageController {
     ...
     *
     * @return monitor_traffic_month.jsp
     */
    ...
    public String accessMonitorPerformanceDB() {
        return "cms/monitor_performance_DB";
    }
    ...
    public String accessMonitorPerformanceServer() {
        return "cms/monitor_performance_server";
    }
    ...
    public String accessMonitorPerformanceRedis() {
        return "cms/monitor_performance_redis";
    }
    ...
    public String accessMonitorPerformanceMemory() {
        return "cms/monitor_performance_memory";
    }
