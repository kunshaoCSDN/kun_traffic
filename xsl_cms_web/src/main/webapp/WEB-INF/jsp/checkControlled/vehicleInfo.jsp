...
<div class="mini-fit">
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:380px;"
         url="/checkControlled/all/vehicle" ajaxOptions="{type:'get', async: true, data: {},
    ...
    >
        <div property="columns">
            ...
            <div field="drIsAlarm" width="100" allowSort="true" align="center" headerAlign="center">是否报警</div>
