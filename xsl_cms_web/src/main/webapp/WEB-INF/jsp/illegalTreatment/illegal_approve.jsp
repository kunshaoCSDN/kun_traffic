<%--
  ...
  Date: 2018/10/08
  Time: 下午 12:55
  Function : 违法事实的审核，决定是否要进行法律责任（如果没有通过要写出否定的原因）
--%>
...
<div id="datagrid1" class="mini-datagrid" style="width:100%;height:380px;"
     url="/illegalTreatment/illegalApprove/all"
     allowResize="true"
     sizeList="[20,30,50,100]" pageSize="10"
     ondrawcell="draw">
    <div property="columns">
        <div type="indexcolumn"></div>
        <div field="dPlace" width="120" headerAlign="center" align="center" allowSort="true">检测地区</div>
        <div field="drCarsign" width="120" headerAlign="center" align="center"  allowSort="true">车牌号</div>
        <div field="icId" width="100" headerAlign="center" align="center" headerAlign="center">违法代码</div>
        <div field="irRemark" align="center" headerAlign="center" width="100" allowSort="true">备注</div>
        <div name="irImg" field="irImg" width="100" align="center" headerAlign="center" >图片</div>
