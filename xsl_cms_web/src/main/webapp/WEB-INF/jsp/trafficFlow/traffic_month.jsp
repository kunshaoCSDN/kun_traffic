...
<div class="mini-fit">
        ...
        <table style="width:100%;">
            <tr>
                ...
                <td style="white-space:nowrap;">
                    <input id="key" class="mini-datepicker" format="yyyy-MM" emptyText="选择月份" showTodayButton="false" showClearButton="false" style="width:150px;" allowSort="true" onenter="onKeyEnter"/>
                    <input id="key1" class="mini-combobox" emptyText="选择站点" style="width:150px;" url="/trafficFlow/device/place" onenter="onKeyEnter"/>
    ...
    <div id="datagrid1" class="mini-datagrid" style="width:100%;height:380px;"
         url="/trafficFlow/month/select" ajaxOptions="{type:'Post', async: true, data: {},
