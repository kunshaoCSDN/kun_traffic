...
<div class="navbar">
    <div class="navbar-header">
        <div class="navbar-brand">智能交通管理系统</div>
        <div class="navbar-brand navbar-brand-compact">CMS</div>
    </div>
    ...
    <div class="main">
        <div id="mainTabs" class="mini-tabs main-tabs" activeIndex="0" style="height:100%;" plain="false"
            ...
            <div name="index" iconCls="fa-android" title="控制台">
                <img src="../static/image/main.jpg" style="width: 1120px;height: 500px" alt="">
            </div>
        </div>
        <div id="tabsButtons">
