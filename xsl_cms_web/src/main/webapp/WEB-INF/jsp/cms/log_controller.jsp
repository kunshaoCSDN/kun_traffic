...
>
    <div property="columns">
        ...
        <div name="operation"  field="operation" align="center" headerAlign="center" allowSort="true" width="250" >操作记录</div>
        <div name="operationer"  field="operationer" align="center" headerAlign="center" allowSort="true" width="150" >操作人员</div>
        <div name="operationtime" field="operationtime" headerAlign="center" align="center" width="150" allowSort="true" dateFormat="yyyy-MM-dd hh:mm:ss">操作时间</div>
    </div>
</div>
</div>
