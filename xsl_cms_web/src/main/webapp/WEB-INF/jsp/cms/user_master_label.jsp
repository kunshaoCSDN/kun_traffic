        ...
        <table style="width:100%;">
            <tr>
                <td style="width:100%;">
                    ...
                    <a class="mini-button" iconCls="icon-remove" onclick="removeRow('/master/tag/delete')" plain="true">删除</a>
                    <span class="separator"></span>
                    <a class="mini-button" iconCls="icon-save" onclick="saveData('/master/tag')" plain="true">保存</a>
                </td>
                <td style="white-space:nowrap;">
                    <input id="key" class="mini-textbox" emptyText="请输入雇主标签ID" style="width:150px;" onenter="onKeyEnter"/>
...
<div id="datagrid1" class="mini-datagrid" style="height:380px;"
     url="/master/tag/list" idField="id"
...
>
    <div property="columns">
        ...
        <div name="id"  field="id" headerAlign="center" allowSort="true" width="100" >雇主标签ID</div>
        <div field="masterid" width="120" headerAlign="center" allowSort="true">雇主ID
            <!-- 添加编辑信息 -->
