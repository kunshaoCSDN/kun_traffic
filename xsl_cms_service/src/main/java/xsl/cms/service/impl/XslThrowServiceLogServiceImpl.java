...
import xsl.cms.service.IXslThrowServiceLogService;
 ...
 *  @author 王坤
 */
@Service("iXslThrowServiceLogService")
@Transactional
public class XslThrowServiceLogServiceImpl implements IXslThrowServiceLogService {
